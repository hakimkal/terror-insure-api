...
-- Generated on Oct 10, 2013 at 12:31 PM
...
ALTER TABLE local_govt DROP CONSTRAINT fk_state CASCADE;
...
-- Table structure for `local_govt`
...
COMMENT ON TABLE local_govt IS 'Local governments in Nigeria.';

-- Insert data into `local_govt`
...
ALTER TABLE local_govt
  ADD CONSTRAINT fk_state FOREIGN KEY (state_id) REFERENCES state (id_no) ON DELETE NO ACTION ON UPDATE NO ACTION;


-- Reset character encoding
